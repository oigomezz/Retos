...
void display(int n, int left, int right)
{
  ...
  cout << "S = " << tree[n].sum << " Mx = " << tree[n].max_sum << " MxL = " << tree[n].max_left_sum << " MxR = " << tree[n].max_right_sum << " Mn = " << tree[n].min_sum << " MnL = " << tree[n].min_left_sum << " , MnR = " << tree[n].min_right_sum << endl;
