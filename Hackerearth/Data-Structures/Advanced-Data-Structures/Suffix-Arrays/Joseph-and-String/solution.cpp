...
public:
  ...
  void sa_is(const AlphaT *str, Index n, int AlphaSize, Index *sa, vector<Index> &bucketOffsets);
  template <typename AlphaT>
  void inducedSort(const AlphaT *str, Index n, int AlphaSize, const vector<bool> &types, Index *sa, vector<Index> &bucketOffsets);
  template <typename AlphaT>
  void countAlphabets(const AlphaT *str, Index n, int AlphaSize, vector<Index> &bucketOffsets, bool b = false);
  template <typename AlphaT>
  void getBucketOffsets(const AlphaT *str, Index n, bool dir, int AlphaSize, vector<Index> &bucketOffsets);
